...
class Admin extends Controller
{
    ...
    public function editCustomGo($data)
    {
        ...
        }else if($data == "eventpubg"){
            $this->model('User_model')->hapusPendaftarPubg($_POST);
        }else if($data == "user"){
            $this->model('User_model')->hapusUser($_POST);
        }else if($data == "custom"){
            $this->model('User_model')->custom();
        }
    ...
    {
        $data['judulHalaman'] = "Schedule";
        // $data['result_schedule'] = $this->model('Custom_model')->createScheduleTable();
        // $data['added_schedule'] = $this->model('Custom_model')->insertSchedule();
