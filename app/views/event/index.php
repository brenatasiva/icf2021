                                ...
                                if ($data['judulHalaman'] == "Seminar - ICF 2021") {
                                    echo '<td class="riwayat-daftar-seminar">
                                            ...
                                            <td class="riwayat-daftar-seminar">
                                             ...
                                             <td class="riwayat-daftar-seminar">
                                                <div class="half-content wa-group">
                            ...
                            <?php } else if ($data['judulHalaman'] == "Lomba - ICF 2021") { ?>
                                ...
                                <td class="daftar-lomba">
                                    <div class="half-content" style="text-align: center !important;">
                                        ...
                                        echo (($key['jenis'] == "Lomba Kelompok") ? ($status == "Open") ? ('<form action="' . BASEURL . '/event/formLomba" method="post" class="centered-content"><button class="btn btn-style ' . $class_enabled . '" name="eid" value="' . $key['id'] . '">Sign Up</button></form>') : ('<button class="btn btn-style ' . $class_enabled . '" name="eid" value="' . $key['id'] . '">Sign Up</button>') : '<span class="centered-content"><button class="btn btn-style ' . $class_enabled . '" data-bs-toggle="modal" href="#modalToggle' . $key['id'] . '" role="button">Sign Up</button></span>');
                                        // $class_enabled = 'btn-outline-secondary btn-disabled disabled';
                                        // echo (($key['jenis'] == "Lomba Kelompok") ? '<button class="btn btn-style ' . $class_enabled . '">Sign Up</button>' : '<span class="centered-content"><button class="btn btn-style ' . $class_enabled . '" role="button">Sign Up</button></span>');

                                        // ($status == "Open") ? ('<form action="' . BASEURL . '/event/formLomba" method="post" class="centered-content"><button class="btn btn-style ' . $class_enabled . '" name="eid" value="' . $key['id'] . '">Sign Up</button></form>') : ('<button class="btn btn-style ' . $class_enabled . '" name="eid" value="' . $key['id'] . '">Sign Up</button>')
                                        ?>
                                    </div>
                                </td>
