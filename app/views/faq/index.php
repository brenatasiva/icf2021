    ...
    <div class="container">
        <div class="row" style="padding-top: 60px;">
            <div class="col d-flex justify-content-start align-items-end">
                <img src="<?= BASECSS; ?>/img/white_dot.png" style="width: 20px; height: 20px; margin-bottom: 15px; margin-left: 15px;">
                ...
                <div class="accordion-item" style="margin-left: auto; margin-right: auto;">
                    <h2 class="accordion-header" id="heading<?= $result[0]; ?>">
                        <button class="accordion-button collapsed justify-content-between" style="font-weight: lighter !important;" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?= $result[0]; ?>" aria-expanded="false" aria-controls="collapse<?= $result[0]; ?>">
                            <?= $key['pertanyaan']; ?>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" style="margin-left: 10px; flex-shrink: 0;" viewBox="0 0 16 16">
                                <path d="M8 0a1 1 0 0 1 1 1v6h6a1 1 0 1 1 0 2H9v6a1 1 0 1 1-2 0V9H1a1 1 0 0 1 0-2h6V1a1 1 0 0 1 1-1z" />
                            </svg>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash-lg" style="margin-left: 10px; flex-shrink: 0;" viewBox="0 0 16 16">
