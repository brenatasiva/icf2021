<style type="text/css">
    .user-bg {
        background-image: url("<?= BASECSS; ?>/img/login_bg.jpg");
        ...
        <div class="d-flex flex-column justify-content-center">
            <div class="d-flex justify-content-center inner-container">
                <div class="crop-login">
                    <img src="<?= BASECSS; ?>/img/icf_2021_blue_logo.png" class="logo-icf">
                </div>
            </div>
            <div class="d-flex justify-content-center">
                <form class="w-50 form-user-input" method="post" action="<?= BASEURL; ?>/user/resetPassword">
                    ...
                    <div class="pb-2" style="position: relative;">
                        ...
                        <input type="password" class="form-control user-input" id="password1" style="padding-right: 3rem;" name="password" placeholder="New Password" required>
                    </div>
                    <div class="pb-2" style="position: relative;">
                        <button type="button" class="btn-eye" tabindex="-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" id="eyeShow" class="bi bi-eye" viewBox="0 0 16 16">
                        ...
                        <input type="password" class="form-control user-input" id="password2" style="padding-right: 3rem;" name="repassword" placeholder="Re-type Password" required>
                    </div>
                    <div class="pt-4 pb-5">
