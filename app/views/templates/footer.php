    ...
    <style type="text/css">
        .footer-bg {
            background-image: url("<?= BASECSS; ?>/img/Footer_BG.jpg");
        ...
        <div class="container d-flex justify-content-between align-items-center" style="height: auto;">
            <ul class="list-group">
                <li class="bg-transparent border-0 list-unstyled text-light mb-3">
                    <h5 class="fw-bold circular-icf">CONTACT US</h5>
                </li>
                <li class="bg-transparent border-0 list-unstyled mb-1">
                    <a class="clickable-link inactive-link" href="#">
                        <svg class="svg-icon" style="margin-bottom: 4px; margin-right: 10px;" width="16" height="16" viewBox="0 0 19 16">
                        ...
                        <span>icf@event.ubaya.ac.id</span>
                    </a>
                </li>
                <li class="bg-transparent border-0 list-unstyled mb-1">
                    <a class="clickable-link" href="https://www.instagram.com/icfubaya2021/" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" style="margin-bottom: 4px; margin-right: 10px;" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                        ...
                        <span>icfubaya2021</span>
                    </a>
                </li>
                <li class="bg-transparent border-0 list-unstyled mb-1">
                    <a class="clickable-link" href="https://lin.ee/kSsQobc" target="_blank">
                        <svg fill="#fff" xmlns="http://www.w3.org/2000/svg" style="margin-bottom: 4px; margin-right: 8px;" viewBox="4 2 47 47" width="18" height="18">
            ...
            <div class="crop-footer">
                <img src="<?= BASECSS; ?>/img/logoicf_footer.png" style="width: 210px;">
            </div>
        </div>
    </footer>
