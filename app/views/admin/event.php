            ...
            ?>
                <tr>
                    ...
                    <td style="min-width: 130px;">
                        <a class="btn btn-altorange me-3" id="editEvent" data-id="<?= $key['id']; ?>" data-bs-toggle="modal" data-bs-target="#modalEvent">Edit</a>
                        <a href="<?= BASEURL; ?>/admin/detil/<?= $key['id']; ?>" class="btn btn-altdarkgrey me-3">Detail</a>
    ...
    $('body').on('click', '#editEvent', function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#selectStatus').val(data.event.status); 
