...
<div class="mapouter">
    ...
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="90px" height="90px;" x="0px" y="0px"
  viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;fill:#f36f25" xml:space="preserve">
    ...
    <div class="gmap_canvas"><iframe width="100%" height="700" id="gmap_canvas" 
        src="https://maps.google.com/maps?q=Universitas%20Surabaya&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" 
        marginheight="0" marginwidth="0"></iframe><a href="https://123movies-to.org"></a><br>
        <style>
            .mapouter{position:relative;height:90vh;width:100%;}
        </style>
        <style>
            .gmap_canvas {overflow:hidden;background:none!important;height:700px;width:100%;}
        </style>
        <style>
            .bg-location { background: rgb(1,151,148);
background: linear-gradient(90deg, rgba(1,151,148,1) 0%, rgba(5,132,187,1) 100%); width:100%; height:150px;}
        </style>
    </div>
</div>
<!-- END OF LOCATION -->
