<style>
    div.desc {
        background-image: url("<?= BASECSS; ?>/img/bgvideo.jpg");
...
<div class="h-auto" style='width:100%; position:relative;'>
    <div style="text-align:right; position: relative;">
        <img src="<?= BASECSS; ?>/img/hero-main.jpg" alt="" class="home-hero-img">
        <div class='h-100 home-hero-gradient'></div>
    </div>
    <div class='h-100 d-flex container home-hero-text-container'>
        <img src="<?= BASECSS; ?>/img/welcome.png" class='home-hero-text' style='aspect-ratio:320/203;' alt="">
    </div>
</div>
<!-- END OF HERO -->
...
<div class="desc d-lg-flex align-items-center">
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="text-center video-desc">
...
<div style='height: 30vh; width:100%; background:#efece7;'>
    <div style='position:relative; display: flex; top: 160px; left: 15%; width:fit-content;'> <img src="<?= BASECSS; ?>/img/dotted.png" class='dotted-title' alt="">
...
<div class="w-100 d-flex justify-content-between">
    ...
    <div class="row timeline-img w-100" style="background-color:#efece7;">
        ...
        <div class="col-md-6 d-none d-md-block" style="background-color:#efece7; border:none;padding:2px;">
            <img src="<?= BASECSS; ?>/img/poster.png" style='width:100%;aspect-ratio:width/height' alt="">
        </div>
    </div>
...
<div style='height: auto; width:100%;'>
    <img style='width:100%; aspect-ratio: 1920/366; pointer-events: none;' src='<?= BASECSS; ?>/img/vectorline.jpg'>
</div>
<!-- END OF TIMELINE -->
